...
<html lang="es">
  ...
  <body id="proyectos">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
              ...
              <li class="nav-item">
                <a class="nav-link px-4 py-1 active" href="proyectos.php"
                  >Proyectos</a
                >
              </li>
              <li class="nav-item">
      ...
      <div class="row mt-4 pb-1">
        <div class="col-12 col-sm-3 text-sm-start">
          <a href="https://github.com/" target="_blank"
            ><i class="fa-brands fa-github frojo"></i
          ></a>
        ...
        <div class="col-12 col-sm-3 pt-2 p-sm-0">
          <a href="mailto:juanituza85@gmail.com" target="_blank"
            class="fnegro">juanituza85@gmail.com</a
          >
        </div>
      </div>
    </footer>
    ...
    <div class="whatsapp col-12 col-sm-3">
      <a
        href="https://wa.me/5491150571913?text=hola!%20Quisiera%20contactar"
        target="_blank"
        title="whatapps"
      >
