      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            ...
            <li class="nav-item">
              <a class="nav-link px-4 py-1 active" href="about_me.php">about me</a>
            </li>
            <li class="nav-item">
      ...
      <div class="row">
        <div class="col-12 col-sm-5 mt-5">
          <div class="col-6 col-sm-6 mt-4">
            <h1 class="text-center">Hello! </br> I'm Juan!</h1>
          </div>
          <div>
            <p class="info">
              Starting my path in programming. Taking courses and training to train me in the career. I hope you find yourself comfortable browsing my portfolio and we can contact you soon!
            </p>
          </div>
    ...
    <section id="laboral" class="container">
      ...
      <div class="row shadow bg-white rounded p-1">
        ...
        <div class="col-12 col-sm-10 pt-5">
          ...
          <div>
            <p class="info">
              Telephone sales of courses for agribusiness. Endorsed by the Argentine Rural Society and the National University of La Plata
            </p>
          </div>
        </div>
        <div class="col-2 p-5 my-auto d-none d-sm-block">
        ...
        <div class="col-12 col-sm-10 pt-5">
          ...
          <div>
            <p class="info">
              I entered the customer service sector as telephone technical support, after 1 year I transferred to the technical base as administrative until 2017 where I transferred to home service for all the company's products.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="row shadow bg-white rounded ">
        ...
        <div class="col-12 col-sm-10 pt-5">
          <div>
            <h3>Dreamweaver CS5/CS6: Website construction</h3>
          </div>
          <div>
            <h4>Educación IT</h4>
          </div>
